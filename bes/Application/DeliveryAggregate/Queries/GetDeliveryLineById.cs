...
namespace BES.Application.DeliveryAggregate.Queries.GetDeliveryLineById;

public class GetDeliveryLineById : IRequest<DeliveryDto>
{
    public long Id { get; set; }
}

public class GetDeliveryLineByIdHandler : IRequestHandler<GetDeliveryLineById, DeliveryDto>
{
    private readonly IApplicationDbContext _context;
    private readonly IMapper _mapper;

    public GetDeliveryLineByIdHandler(IApplicationDbContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }

    public async Task<DeliveryDto> Handle(GetDeliveryLineById request, CancellationToken cancellationToken)
    {
        try {
