...
public class GetJobWithPagination : IRequest<PaginatedList<JobDto>>
{
...
public class GetJobWithPaginationHandler : IRequestHandler<GetJobWithPagination, PaginatedList<JobDto>>
{
    private readonly IApplicationDbContext _context;
    private readonly IMapper _mapper;
    public GetJobWithPaginationHandler(IApplicationDbContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }
    public async Task<PaginatedList<JobDto>> Handle(GetJobWithPagination request, CancellationToken cancellationToken)
    {
        try 
        {
            var DueDate = "";
