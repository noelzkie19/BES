...
namespace BES.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20221108023324_Add_NonConformance")]
    partial class Add_NonConformance
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BES.Domain.Entities.NonConformance", b =>
                {
                    ...
                    b.Property<string>("NatureOfNonConformance")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NcrClearedBy")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("UnderTakenBy")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BES.Domain.Entities.OperationOperator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OperationOperators");
                });

            modelBuilder.Entity("BES.Domain.Entities.OperationResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BES.Domain.Entities.OperationOperator", b =>
                {
                    b.HasOne("BES.Domain.Entities.Operation", "Operation")
                        .WithMany()
