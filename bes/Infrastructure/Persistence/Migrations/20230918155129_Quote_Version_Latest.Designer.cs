...
namespace BES.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230918155129_Quote_Version_Latest")]
    partial class Quote_Version_Latest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BES.Domain.Entities.ClientEmailHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ClientEmailHistories");
                });
            ...
            modelBuilder.Entity("BES.Domain.Entities.EmailAuth", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<byte[]>("EncryptPassword")
                        .IsRequired()
                        .HasColumnType("varbinary(max)");

                    b.Property<byte[]>("InitVector")
                        .IsRequired()
                        .HasColumnType("varbinary(max)");
            ...
            modelBuilder.Entity("BES.Domain.Entities.FileStorage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BES.Domain.Entities.Job", b =>
                {
                    ...
                    b.Property<DateTime?>("JobDatePrinted")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<decimal>("LabourCostRate")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("MaterialCostVariable")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int>("QtyAuthorisedOverruns")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BES.Domain.Entities.NcrNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BES.Domain.Entities.NonConformance", b =>
                {
                    ...
                    b.Property<string>("CorrectiveNotes")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ReviewOfCorrectiveAction")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BES.Domain.Entities.Operation", b =>
                {
                    ...
                    b.Property<bool>("ProInsFirst1")
                        .HasColumnType("bit");

                    b.Property<bool>("ProInsFirst2")
                        .HasColumnType("bit");

                    b.Property<bool>("ProInsFirst3")
                        .HasColumnType("bit");

                    b.Property<bool>("ProInsINS")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BES.Domain.Entities.Purchase", b =>
                {
                    ...
                    b.Property<bool>("IsCallReadyQuoting")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BES.Domain.Entities.Quote", b =>
                {
                    ...
                    b.Property<DateTime>("DateLatestVersion")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("Is30DaysFromInv")
                        .HasColumnType("bit");

                    b.Property<bool>("IsCod")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDepositReceivedCOD")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("ProgressPaymentRequired")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BES.Domain.Entities.QuoteDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BES.Domain.Entities.SupplierEmailHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SupplierEmailHistories");
                });
            ...
            modelBuilder.Entity("BES.Domain.Entities.Job", b =>
                {
                    ...
                    b.HasOne("BES.Domain.Entities.Quote", "Quote")
                        .WithMany()
                        .HasForeignKey("QuoteNumberSource");
            ...
            modelBuilder.Entity("BES.Domain.Entities.Operation", b =>
                {
                    ...
                    b.HasOne("BES.Domain.Entities.Resource", "ResourceDetail")
                        .WithMany()
            ...
            modelBuilder.Entity("BES.Domain.Entities.SupplierEmailHistory", b =>
                {
                    b.HasOne("BES.Domain.Entities.Supplier", "Supplier")
                        .WithMany("SupplierEmailHistories")
                        .HasForeignKey("SupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BES.Domain.Entities.Client", b =>
                {
                    ...
                    b.Navigation("ClientEmailHistories");
            ...
            modelBuilder.Entity("BES.Domain.Entities.Supplier", b =>
                {
                    ...
                    b.Navigation("SupplierEmailHistories");
                });
