...
namespace BES.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20221101142301_Job_SubAssembly_Relation")]
    partial class Job_SubAssembly_Relation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BES.Domain.Entities.JobSubAssembly", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("ParentJobNumber");

                    b.ToTable("JobSubAssemblies");
                });
            ...
            modelBuilder.Entity("BES.Domain.Entities.SalesInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BES.Domain.Entities.SubSalesInformations", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SubSalesInformations");
                });
            ...
            modelBuilder.Entity("BES.Domain.Entities.DeliveryLine", b =>
                {
                    ...
                    b.HasOne("BES.Domain.Entities.Job", "Job")
                        .WithMany("DeliveryLines")
                        .HasForeignKey("JobNumber")
                        .HasPrincipalKey("JobNumber")
                        .IsRequired();
            ...
            modelBuilder.Entity("BES.Domain.Entities.SalesInformation", b =>
                {
                    b.HasOne("BES.Domain.Entities.Job", "Job")
                        .WithOne("SalesInformations")
                        .HasForeignKey("BES.Domain.Entities.SalesInformation", "JobId")
                        .IsRequired()
                        .HasConstraintName("FK_SalesInformation_Job");
            ...
            modelBuilder.Entity("BES.Domain.Entities.Schedule", b =>
                {
                    b.HasOne("BES.Domain.Entities.Job", "Job")
                        .WithOne("Schedule")
                        .HasForeignKey("BES.Domain.Entities.Schedule", "JobNumber")
                        .HasPrincipalKey("BES.Domain.Entities.Job", "JobNumber")
                        .IsRequired();
            ...
            modelBuilder.Entity("BES.Domain.Entities.SubSalesInformations", b =>
                {
                    b.HasOne("BES.Domain.Entities.JobSubAssembly", "JobSubAssembly")
                        .WithOne("SubSalesInformations")
                        .HasForeignKey("BES.Domain.Entities.SubSalesInformations", "JobNumber")
                        .HasPrincipalKey("BES.Domain.Entities.JobSubAssembly", "JobNumber")
                        .IsRequired();

                    b.Navigation("JobSubAssembly");
                });
            ...
            modelBuilder.Entity("BES.Domain.Entities.Job", b =>
                {
                    ...
                    b.Navigation("SalesInformations")
                        .IsRequired();
            ...
            modelBuilder.Entity("BES.Domain.Entities.JobSubAssembly", b =>
                {
                    b.Navigation("SubSalesInformations")
                        .IsRequired();
                });
