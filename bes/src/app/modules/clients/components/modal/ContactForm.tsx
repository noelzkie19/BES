...
import {contactFormValidationSchema} from '../../validators/client-form'
import { Dialog, DialogActionsBar } from "@progress/kendo-react-dialogs";
import PhoneInput from 'react-phone-input-2'

type Props = {
  handleClose: () => void
  onSuccess?: (values: IClientContact, dataIndex: number) => void
  contactValue?: IClientContact
  dataIndex: number
}
...
const ContactForm: React.FC<Props> = ({handleClose, onSuccess, contactValue, dataIndex}) => {
  const {
    ...
    defaultValues: contactValue ? {...contactValue} : CLIENT_CONTACT_DEFAULT,
